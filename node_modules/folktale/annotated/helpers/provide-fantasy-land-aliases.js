...
var aliases = {
  ...
  }, __metamagical_withMeta(_or['fantasy-land/alt'], {
    'name': 'fantasy-land/alt',
    'source': '\'fantasy-land/alt\'(value) {\n      return this.or(value);\n    }',
    'signature': 'fantasy-land/alt(value)',
    'location': {
      'filename': 'source/helpers/provide-fantasy-land-aliases.js',
      'start': {
        'line': 95,
  ...
  }), __metamagical_withMeta(_or['alt'], {
    'name': 'alt',
    'source': 'alt(value) {\n      return this.or(value);\n    }',
    'signature': 'alt(value)',
    'location': {
